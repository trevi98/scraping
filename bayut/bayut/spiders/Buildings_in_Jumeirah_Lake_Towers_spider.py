...
from ..items import Buildings_in_Jumeirah_Lake_TowersItem
import requests
...
class testingSpider(scrapy.Spider):
    name = 'Buildings_in_Jumeirah_Lake_Towers'
    start_urls = ["https://www.bayut.com/buildings/jumeirah-lake-towers-jlt/"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.bayut.com/buildings/jumeirah-lake-towers-jlt/page/{self.page_number}"
    ...
    def page(self,response):
        ...
        items = Buildings_in_Jumeirah_Lake_TowersItem()
