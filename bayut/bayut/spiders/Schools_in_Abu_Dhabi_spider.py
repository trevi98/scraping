...
from ..items import schools_abu_dhabiItem
import requests
...
class testingSpider(scrapy.Spider):
    name = 'schools_in_abu_dhabi'
    start_urls = ["https://www.bayut.com/schools/abu-dhabi/"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.bayut.com/schools/abu-dhabi/page/{self.page_number}"
