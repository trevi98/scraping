...
from ..items import Schools_in_AjmanItem
import requests
...
class testingSpider(scrapy.Spider):
    name = 'Schools_in_Ajman'
    start_urls = ["bayut.com/schools/ajman/"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"bayut.com/schools/ajman/page/{self.page_number}"
