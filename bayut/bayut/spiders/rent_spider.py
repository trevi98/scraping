...
class testingSpider(scrapy.Spider):
    name = 'rent'
    start_urls = ["https://www.bayut.com/to-rent/property/uae"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.bayut.com/to-rent/property/uae/page-{self.page_number}"
        if next_page is not None and self.page_number < 2080:
            self.page_number +=1
            self.link = one
