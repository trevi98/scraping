...
async function main_loop(page, i) {
  let target = `https://www.providentestate.com/all-properties-for-sale.html/page/${i}`;
  if (i == 1) {
    target = "https://www.providentestate.com/all-properties-for-sale.html";
  }
  console.log(target);
  ...
  if (i == 1 || i % 20 == 0 || i == 95) {
    const message = `Done - buy prov ${i} done`;
