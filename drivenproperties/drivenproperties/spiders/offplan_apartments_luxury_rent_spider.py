import scrapy
from ..items import RentapartmentLuxuryItem
import requests
...
class testingSpider(scrapy.Spider):
    name = 'apartment_luxury_rent'
    start_urls = ["https://www.drivenproperties.com/dubai/luxury-apartments-for-rent?page=1"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.drivenproperties.com/dubai/luxury-apartments-for-rent?page={self.page_number}/"
