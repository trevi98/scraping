...
class testingSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.drivenproperties.com/dubai/off-plan-properties-and-projects-for-sale?page=1"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.drivenproperties.com/dubai/off-plan-properties-and-projects-for-sale?page={self.page_number}/"
