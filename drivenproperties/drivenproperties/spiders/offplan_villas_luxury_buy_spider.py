import scrapy
from ..items import villaBuyLuxuryItem
import requests
...
class testingSpider(scrapy.Spider):
    name = 'villa_luxury_buy'
    start_urls = ["https://www.drivenproperties.com/dubai/luxury-villas-for-sale?page=1"]
    page_number = 2
    link = ""
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.drivenproperties.com/dubai/luxury-villas-for-sale?page={self.page_number}/"
