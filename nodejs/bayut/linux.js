...
(async () => {
  ...
  for(let i=1 ; i<=2050 ; i++){
    let target = `https://www.bayut.com/for-sale/property/dubai/page-${i}/`;
    if(i == 1){
      target = 'https://www.bayut.com/for-sale/property/dubai/'
    }
