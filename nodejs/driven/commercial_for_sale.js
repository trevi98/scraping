...
function csv_handler(directory, batch) {
  ...
  return createCsvWriter({
    path: `${directory}/commercial_for_sale${batch}.csv`,
    header: [
...
let csvErrr = csv_error_handler("commercial_for_sale");
let csvWriter = csv_handler("commercial_for_sale", 1);
let batch = 0;
let j = 0;
...
async function visit_each(link, page) {
  ...
  if (j % 500 == 0) {
    batch++;
    csvWriter = csv_handler("commercial_for_sale", batch);
  }
