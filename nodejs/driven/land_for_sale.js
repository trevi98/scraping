...
function csv_handler(directory, batch) {
  ...
  return createCsvWriter({
    path: `${directory}/land_for_sale${batch}.csv`,
    header: [
...
let csvErrr = csv_error_handler("land_for_sale");
let csvWriter = csv_handler("land_for_sale", 1);
let batch = 0;
let j = 0;
...
async function visit_each(link, page) {
  ...
  if (j % 500 == 0) {
    batch++;
    csvWriter = csv_handler("land_for_sale", batch);
  }
