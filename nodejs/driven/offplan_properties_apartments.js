...
function csv_handler(directory, batch) {
  ...
  return createCsvWriter({
    path: `${directory}/offplan_properties_apartments${batch}.csv`,
    header: [
...
let csvErrr = csv_error_handler("offplan_properties_apartments");
let csvWriter = csv_handler("offplan_properties_apartments", 1);
let batch = 0;
let j = 0;
...
async function visit_each(link, page) {
  ...
  if (j % 500 == 0) {
    batch++;
    csvWriter = csv_handler("offplan_properties_apartments", batch);
  }
