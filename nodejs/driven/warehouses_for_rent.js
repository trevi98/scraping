...
function csv_handler(directory, batch) {
  ...
  return createCsvWriter({
    path: `${directory}/warehouses_for_rent${batch}.csv`,
    header: [
...
let csvErrr = csv_error_handler("warehouses_for_rent");
let csvWriter = csv_handler("warehouses_for_rent", 1);
let batch = 0;
let j = 0;
...
async function visit_each(link, page) {
  ...
  if (j % 500 == 0) {
    batch++;
    csvWriter = csv_handler("warehouses_for_rent", batch);
  }
