...
async function main_loop(page,i){
  ...
  let target = `https://www.propertyfinder.ae/en/search?c=1&cs=off_plan&l=1&ob=mr&page=${i}`;
//   if(i == 1){
//     target = 'https://www.bayut.com/for-sale/property/dubai/?completion_status=off-plan'
//   }
  await page.goto(target);
  const links = await page.evaluate(() => {
    const anchors = Array.from(document.querySelectorAll('[data-qs=property-list] .card a   '),a=>a.href);
