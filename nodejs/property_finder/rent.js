...
async function main_loop(page, i) {
  let target = `https://www.propertyfinder.ae/en/rent/properties-for-rent.html?page=${i}`;
  if (i == 1) {
    target = "https://www.propertyfinder.ae/en/rent/properties-for-rent.html";
  }
  console.log(target);
