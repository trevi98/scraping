...
class testingSpider(scrapy.Spider):
    link = ""
    name = 'commercial_buy'
    start_urls = ["https://www.propertyfinder.ae/en/search?c=3&ob=mr&page=1"]
    page_number = 2
    ...
    def parse(self,response):
        ...
        next_page = f"https://www.propertyfinder.ae/en/search?c=3&ob=mr&page={self.page_number}"
        if next_page is not None and self.page_number < 165:
            ...
            data = {"message": "prop finder commercial_buy"}
